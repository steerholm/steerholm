...
The `holm` CLI is the admin interface for your MCP servers, agents, and their
access. Commands read verb-first — `holm <verb> <resource> [name]` — because
Steerholm is your control plane — you add agents and servers to it and govern their access. Agents themselves connect to
