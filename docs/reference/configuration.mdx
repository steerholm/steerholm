...
| `id` | `string` | Immutable id, minted at creation. `null` for servers created before ids existed |
...
| `id` | `string` | Immutable id, minted at creation and kept across key rotation. `null` for agents created before ids existed |
