...
<CardGroup cols={2}>
  <Card title="harbour" icon="terminal" color="#10b981">
    Admin CLI for the user. Manages servers, agents, policies, and the daemon. Belongs to the Action Plane.
  </Card>
...
<Steps>
  ...
  <Step title="Authentication">
    The client sends `Authorization: Bearer harbour_sk_...`. The daemon resolves the agent by checking the access key against stored hashes. The access key determines the agent — it cannot be self-declared.
  </Step>
